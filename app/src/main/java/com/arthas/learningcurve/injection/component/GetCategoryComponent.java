 ...
 */
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, GetCategoryModule.class})
public interface GetCategoryComponent extends ActivityComponent {
  void inject(MyCategoryActivity activity);
}
