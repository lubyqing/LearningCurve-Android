 ...
 */
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, UserManageModule.class})
public interface UserManageComponent extends ActivityComponent {
